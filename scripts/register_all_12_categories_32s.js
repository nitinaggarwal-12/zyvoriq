...
const ALL_12_TRACKS = [
  ...
  // 7. Culinary (32s Wagyu Masterclass)
  {
  ...
  // 8. Wellness & Vedanta (32s Meditation)
  {
  ...
  // 10. Science & Space (32s AlphaFold 3 Molecular Design)
  {
  ...
  // 11. History & Geopolitics (32s Mohenjo-Daro Archaeology)
  {
  ...
  // 12. Finance & Wealth (32s Central Bank Macro Breakdown)
  {
...
tsCode += "export const CANONICAL_SERIES_TRACKS: SeriesTrack[] = " + JSON.stringify(ALL_12_TRACKS, null, 2)
...
ALL_12_TRACKS.forEach((track, idx) => {
  const timeOffset = `-${(ALL_12_TRACKS.length - idx) * 10} minutes`;
...
console.log(`🎉 Successfully registered all ${ALL_12_TRACKS.length} 100% genuine Veo 3.1 32s-120s productions!`);
