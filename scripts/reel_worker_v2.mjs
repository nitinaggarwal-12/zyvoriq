...
async function applyNarration(op, result) {
  ...
  if (op.payload_json?.studio1) synchronizeStudio1ManifestTimeline(m, { mode: "plan", resetAssets: true });
