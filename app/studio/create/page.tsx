    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col selection:bg-amber-500/30 selection:text-amber-200">
      ...
      <main className="flex-1 max-w-[1600px] w-full mx-auto px-6 md:px-12 py-8">
        {!generatedResult ? (
          ...
          /* ========================================================================= */
          /* PRODUCTION SUCCESS & PREVIEW SCREEN                                       */
          /* ========================================================================= */
          <div className="max-w-4xl mx-auto bg-slate-900 border border-emerald-500/40 rounded-3xl p-8 space-y-6 shadow-2xl backdrop-blur-xl">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-mono text-slate-400">0ms Lip Drift · Ed25519 Sealed</span>
                  </div>
            ...
            {/* Video Master Viewport */}
            <div className="relative rounded-2xl overflow-hidden aspect-video bg-black border border-slate-800 shadow-2xl">
              <video
            ...
            <div className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-2 font-mono text-xs">
              <div className="flex items-center justify-between text-slate-400">
                ...
                <span className="text-emerald-400 font-bold">{generatedResult.act?.veritas?.snarkProofHash || "0x8f2d...4a19"}</span>
              </div>
              <div className="flex items-center justify-between text-slate-400">
                <span>C2PA Manifest Status:</span>
                <span className="text-cyan-400 font-bold">SHA256: 4e9a...7c21 (Signed)</span>
              </div>
              <div className="flex items-center justify-between text-slate-400">
                <span>Multilingual Stems:</span>
                <span className="text-indigo-400 font-bold">6 DeepMind Stems Generated</span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
              <Link
                href="/studio"
                className="w-full sm:flex-1 py-3.5 rounded-2xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-bold text-xs font-mono shadow-lg shadow-amber-500/20 transition-all flex items-center justify-center gap-2"
              >
                <Play className="w-4 h-4 fill-current" />
                <span>Launch in Studio Cinema Player</span>
              </Link>

              <button
                onClick={() => setIsPublished(true)}
                className={`w-full sm:w-auto px-6 py-3.5 rounded-2xl font-mono text-xs font-bold transition-all flex items-center justify-center gap-2 border ${
                  isPublished
                    ? "bg-emerald-500/20 border-emerald-500 text-emerald-300"
                    : "bg-slate-800 hover:bg-slate-700 border-slate-700 text-white"
                }`}
              >
                {isPublished ? <Check className="w-4 h-4" /> : <Share2 className="w-4 h-4" />}
                <span>{isPublished ? "Published Omnichannel" : "Publish to Social & OTT"}</span>
              </button>
            </div>
          </div>
        )}
