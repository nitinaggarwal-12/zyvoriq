        ...
        <header className="flex flex-wrap items-center justify-between gap-3 pb-4 border-b border-white/10">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <input
              ...
              className="w-64 px-3 py-2 rounded-xl bg-[#0D111A] border border-white/15 text-xs text-white font-mono"
            />
            <Link
              href="/registry"
          ...
          <div className="space-y-6">
            {groupedProjects.map((group) => {
              ...
              return (
                <section
                  key={group.projectId}
                  className="rounded-2xl bg-[#0D111A] border border-white/15 overflow-hidden shadow-2xl transition"
                >
                  {/* =========================================================
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 p-5 items-start">
                    ...
                    <div className="lg:col-span-4">
                      <div className="relative rounded-xl overflow-hidden bg-black border border-white/15 aspect-[9/16] max-h-[440px] w-full flex items-center justify-center">
                        <video
                          src={mainReel.src}
                          controls
                          playsInline
                        ...
                        <span className="pointer-events-none absolute top-2.5 right-2.5 px-2 py-1 rounded-lg bg-black/85 border border-white/15 font-mono text-[10px] text-amber-300">
                    ...
                    <div className="lg:col-span-8 flex flex-col justify-between space-y-4">
                      <div className="space-y-3">
                        ...
                        <p className="text-xs text-slate-300">{mainReel.subtitle}</p>

                        {/* Prompt & Input Parameters Card */}
                        <div className="rounded-xl bg-black/55 border border-white/10 p-4 space-y-2.5 text-xs">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-3 pt-2 border-t border-white/10">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                          <Link
                            ...
                            className="px-3.5 py-2 rounded-xl bg-white/10 hover:bg-white/15 text-xs font-semibold text-white"
                          >
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                        {allChildren.map((child) => {
                          ...
                          return (
                            <article
                              key={child.id}
                              className="rounded-xl bg-[#0D111A] border border-white/10 overflow-hidden flex flex-col justify-between"
                            >
                              <div>
                                <div className="relative aspect-[9/14] max-h-[290px] bg-black flex items-center justify-center">
                                  ...
                                  <span className="pointer-events-none absolute top-2 right-2 px-2 py-0.5 rounded bg-black/85 border border-white/15 font-mono text-[10px] text-amber-300">
                                    {child.durationSec > 0
                              ...
                              <div className="px-3 pb-3 pt-1 space-y-2">
                                ...
                                <div className="flex items-center justify-between gap-2">
                                  <Link
                                    href={childUrl}
                                    className="flex-1 text-center py-1.5 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 font-mono text-[11px] text-emerald-300"
                                  >
                                    Inspect ID →
                                  </Link>
                                  <a
                                    ...
                                    className="px-2.5 py-1.5 rounded-lg bg-white/10 hover:bg-white/20 text-xs text-white"
                                  >
                                    ⬇
                                  </a>
                                </div>
