...
const FEATURE_FILM_SHOWCASE = [
  {
    id: "chronos-protocol",
    title: "THE CHRONOS PROTOCOL: A 5-ACT ANAMORPHIC EPIC",
    ...
    videoUrl: "/renders/yt/yt_spain_pool_party_omni_hybrid.mp4",
    posterUrl: "/samples/yt_spain_pool_party_poster.jpg",
    synopsis:
      "In neo-baroque Madrid, a rogue quantum cryptographer uncovers a temporal anomaly hidden inside a sovereign central bank vault.",
    acts: [
      {
        act: 1,
        title: "Act I: Prologue & Inciting Incident",
        timecode: "0:00 – 0:36",
        seconds: 0,
        description: "Establishing 2.39:1 crane shot over rain-slicked granite columns; protagonist enters vault perimeter.",
        lens: "Cooke Anamorphic 40mm T2.3",
        lighting: "Chiaroscuro tungsten key + cold teal rain reflections",
      },
      {
        act: 2,
        title: "Act II: Rising Tension & Pursuit",
        timecode: "0:36 – 1:12",
        seconds: 36,
        description: "Steadicam unbroken corridor pursuit; biometric security locks trigger sequential blast doors.",
        lens: "Cooke Anamorphic 50mm T2.3",
        lighting: "Strobing amber hazard beacons + deep shadow falloff",
      },
      {
        act: 3,
        title: "Act III: The Midpoint Confrontation",
        timecode: "1:12 – 1:48",
        seconds: 72,
        description: "Two-shot dialogue standoff across the glass server core; orchestral timpani crescendo.",
        lens: "Cooke Anamorphic 75mm Close Focus",
        lighting: "High-contrast volumetric cyan core glow",
      },
      {
        act: 4,
        title: "Act IV: Crisis & Climax",
        timecode: "1:48 – 2:24",
        seconds: 108,
        description: "Zero-gravity temporal fracture inside the atrium; 24fps true motion blur shutter 180-degree lock.",
        lens: "Cooke Anamorphic 32mm Wide",
        lighting: "Blinding golden flare + anamorphic horizontal bokeh",
      },
      {
        act: 5,
        title: "Act V: Resolution & Epilogue",
        timecode: "2:24 – 3:00",
        seconds: 144,
        description: "Slow dolly out at dawn overlooking the city skyline; symphonic strings resolve to minor chord.",
        lens: "Cooke Anamorphic 100mm Telephoto",
        lighting: "Warm golden hour rim light + ACES 1.3 film print emulation",
      },
    ] as CinemaAct[],
  },
];
