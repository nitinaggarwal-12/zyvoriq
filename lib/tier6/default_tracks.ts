...
export const CANONICAL_SERIES_TRACKS: SeriesTrack[] = [
  ...
  {
    id: "track_wildlife_serengeti",
    title: "Serengeti & Masai Mara: The Great Wildlife Odyssey",
    subtitle: "3-Act 4K African Wildlife Documentary · The Great Migration & Apex Predators",
    category: "nature",
    character: "🦁 Dr. Victoria Thorne (Wildlife Biologist)",
    videoSrc: "/assets/video/victoria_master.mp4",
    acts: [
      {
        id: "wildlife_act_1",
        startTime: 0.25,
        endTime: 8.0,
        speaker: "Victoria",
        speakerRole: "Lead Wildlife Biologist",
        actName: "Act 1: Dawn Over the Serengeti Plain",
        philosophy: "Savannah Ecosystem Dynamics",
        text: {
          ja: "🦁 VICTORIA: 「セレンゲティの地平線に昇る朝日。百万頭のヌーが命がけの大移動を開始します。」",
          en: "🦁 VICTORIA: \"Dawn breaks across the golden acacia plains of the Serengeti as the great annual migration begins.\"",
          es: "🦁 VICTORIA: \"El amanecer ilumina las llanuras del Serengeti cuando comienza la gran migración anual.\"",
          fr: "🦁 VICTORIA: « L'aube se lève sur les plaines du Serengeti alors que commence la grande migration annuelle. »",
          de: "🦁 VICTORIA: „Die Morgensonne erhellt die Serengeti-Ebene bei Beginn der großen jährlichen Tierwanderung.“",
          hi: "🦁 विक्टोरिया: \"सेरेनगेटी के सुनहरे मैदानों पर सूर्योदय, महान वार्षिक वन्यजीव प्रवासन की शुरुआत।\""
        }
      },
      {
        id: "wildlife_act_2",
        ...
        speaker: "Victoria",
        speakerRole: "Lead Wildlife Biologist",
        actName: "Act 2: The Mara River Crossing & Apex Predators",
        philosophy: "Hydrological Survival & Predation",
        text: {
          ja: "🦁 VICTORIA: 「マラ川の濁流を渡る群れ。ナイルワニとライオンのプライドが待ち受ける生命の試練です。」",
          en: "🦁 VICTORIA: \"The treacherous crossing of the Mara River where apex Nile crocodiles and lion prides test nature's endurance.\"",
          es: "🦁 VICTORIA: \"El peligroso cruce del río Mara, donde cocodrilos y manadas de leones ponen a prueba la supervivencia.\"",
          fr: "🦁 VICTORIA: « La traversée périlleuse de la rivière Mara où prédateurs et proies s'affrontent pour leur survie. »",
          de: "🦁 VICTORIA: „Die gefährliche Durchquerung des Mara-Flusses fordert den unerbittlichen Überlebenswillen der Herden.“",
          hi: "🦁 विक्टोरिया: \"मारा नदी को पार करने का जोखिम भरा सफर, जहां शिकारी और शिकार जीवन की लड़ाई लड़ते हैं।\""
        }
      },
      {
        id: "wildlife_act_3",
        ...
        speaker: "Victoria",
        speakerRole: "Lead Wildlife Biologist",
        actName: "Act 3: Sunset Harmony & The Sovereign Wild",
        philosophy: "Ecological Equilibrium",
        text: {
          ja: "🦁 VICTORIA: 「夕暮れに染まる大地。何万年と続く生命の輪が、この大自然の調和を永遠に守り続けます。」",
          en: "🦁 VICTORIA: \"As crimson twilight settles over the savannah, the timeless circle of life restores ecological harmony.\"",
          es: "🦁 VICTORIA: \"El crepúsculo carmesí se asienta sobre la sabana, restaurando la armonía ecológica del ciclo de la vida.\"",
          fr: "🦁 VICTORIA: « Le crépuscule écarlate s'installe sur la savane, perpétuant le cycle éternel de la vie sauvage. »",
          de: "🦁 VICTORIA: „Wenn die Dämmerung die Savanne einhüllt, schließt sich der ewige Kreislauf des Lebens in vollkommener Harmonie.“",
          hi: "🦁 विक्टोरिया: \"सवाना पर ढलती शाम के साथ, जीवन का शाश्वत चक्र प्रकृति के संतुलन को बनाए रखता है।\""
        }
      }
    ],
    duration: 24.0,
